      ...
      <nav className="navbar navbar-expand-lg navbar-dark  px-4 ">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <a className='nav-link' href='https://tinyurl.com/compiextn' target="_blank" rel="noopener noreferrer">
                Chrome Extension
              </a>
            </li>

            <li className="nav-item">
              <a className='nav-link' href='http://decoding.surge.sh/' target="_blank" rel="noopener noreferrer">
                Decode
              </a>
            </li>
            
            <li className="nav-item">
              <a className='nav-link' href='https://compecenter.vercel.app/'>
                LogOut
              </a>
            </li>
          </ul>
